...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
  ...
  <tr bgcolor="#FFFFFF"; height="55px";>  
    <td width="76%" rowspan="2"><img src="{{ asset('images/logo_v1-1.jpg') }}" width="286PX" height="59"></td>
  ...
  <tr bgcolor="#F4F7FB">
    <td colspan="3">
      ...
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
        <tbody>
        <tr bgcolor="#327bb2">
            <td colspan="4" class="subtitulo4" align="center"> <br><div align="center">RESUMEN DEL  CENSO POBLACIONAL INDVIDUAL</div><br></td>
          </tr>
        ...
        <tr bgcolor="#243f78">
          ...
          <td colspan="2" height="25px";><div align="left">
            ...
            <span class="subtitulo4"><b>SISTEMA DE INFORMACION POBLACIONAL -SIPEMP</b></span>&nbsp;<font size="0.6px", color="#fff";>-</font>
          </div></td>
        </tr>

        <tr bgcolor="#8398C5">
          <td colspan="4" class="tituloEtiqueta" align="center"><div align="center">DETALLES - PERSONA </div></td>
        </tr>
        <tr bgcolor="#327bb2">
          <td colspan="2" height="25px"; class="subtitulo4">
          ESTADO DEL CENSO 
          ...
          <td colspan="2" height="25px";><div align="left">
            ...
            <span class="subtitulo4"><b> </b></span>&nbsp;<font size="0.6px", color="#fff";>  @if ($temp->status == 1)
        ...
        <td width="26%" bgcolor="#ddd" class="subtitulo2"><strong>NOMBRE COMPLETO</strong></td>
          <td colspan="3" bgcolor="#FFF" class="subtitulo2">{{$temp->nombres}} -{{$temp->apellidos}}&nbsp;</td>
        </tr>
        <tr bgcolor="#FFFFFF">
          ...
          <td width="26%" bgcolor="#FFF" class="subtitulo2">{{$temp->docomento_persona}}&nbsp;</td>
        </tr>
        <tr bgcolor="#FFFFFF">
        ...
        <!--Aqui va el codigo de tablas  informacion del trabajador-->
         ...
         <tr bgcolor="#849AC6">
                ...
                <tr bgcolor="#FFFFFF">
                  ...
                  <td width="23%" bgcolor="#FFF" class="subtitulo2">{{$temp->nombre_reguardo}}&nbsp;</td>
                ...
                <tr bgcolor="#FFFFFF">
                  ...
                  <td width="23%" bgcolor="#FFF" class="subtitulo2">{{$temp->nombre_vereda}}&nbsp;</td>
                  <td width="26%" bgcolor="#ddd" class="subtitulo2"><strong>SECTOR</strong></td>
                  <td width="26%" bgcolor="#FFF" class="subtitulo2">{{$temp->nombre_sector}}&nbsp;</td> 
                </tr>
               <!--
                <tr bgcolor="#FFFFFF">
          ...
          <!--Aqui va el codigo de tablas informacion  trabajo -->
                    ...
                    <tr bgcolor="#849AC6">
                      <td colspan="4" class="tituloEtiqueta" align="center"> <div align="center">INFORMACIÓN - GENARAL DEL RESGUARDO </div></td>
                    </tr>
                ...
                <tr bgcolor="#FFFFFF">
                  <td height="22" bgcolor="#ddd" class="subtitulo2"><strong>CODIGO RESGUARDO</strong></td>
                  <td colspan="3" bgcolor="#FFF" class="subtitulo2">{{$temp->comunidad_indigena}}&nbsp;</td>
                </tr>
                <tr bgcolor="#FFFFFF">
                  <td height="22" bgcolor="#ddd" class="subtitulo2"><strong>RESGUARDO</strong></td>
                  <td colspan="3" bgcolor="#FFF" class="subtitulo2">{{$temp->nombre_reguardo}}&nbsp;</td>
                </tr>
        ...
        <tr bgcolor="#FFFFFF">
          <td colspan="4"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#EEEEEE">
            <tbody><tr bgcolor="#849AC6">
              <td colspan="2" height="25px"; class="subtitulo4"><div align="center" class="Estilo16">SEGUIR CON EL PROCESO DEL CENSO FAMILIAR </div></td>
            </tr>
            <!--
            <tr bgcolor="#FFFFFF">
...
<table width="38%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <!--
              ...
              <td width="45%" class="subtitulo3"><div align="center">
