         ...
         <div class="col-md-3 col-sm-4 col-xs-12 ">    
             ...
             <div class="col-md-9 ">
                 <div class="ContenedorFormularioCenso">
                    ...
                    <span  class="color_infor  noPrint">Usted se encuentra en: &nbsp;&nbsp;Sistema de Informacion Poblacional Misak &gt; <font color="#666666">Censo Vivienda -SIPEMP </font></span>        
                      </div>					
        ...
        <!-- FORMULARIO-->
           ...
           <div class="js-box-laboral-experience" id="experiencia-laboral">
            <h3 class="h4">Ingresar Informacion de la Vievienda</h3>
              ...
              <p class="text-muted">
               Si  el habitante es dueño de la propietario , Ingresar los siguientes datos al sistema de información poblacional Misak -SIPEMP  </p>
                <h4 class="panel-title">
              <button ><a href="#collapse4" data-parent="#accordion" data-toggle="collapse" class=""> Agregar 
   ...
   <!-- ///FORMULARIO////     -->
       ...
       <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">  
             ...
             <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12">
	               <div class="form-group input-group-sm">
					     ...
					     <div class="form-group input-group-sm">
						<div class="titulo_de_formulaario">* Ubicación de La vivienda:: </div>	<!------>
                         <div class="radio icheck-wetasphalt">
                          <input type="radio" id="wetasphalt1" name="wetasphalt"  value="A lado rio"  required="" />
                           <label for="wetasphalt1">Al lado del rio </label>
                          </div>
						  </div>
						     <div class="form-group input-group-sm">
                           <div class="radio icheck-wetasphalt">
                            <input type="radio" checked id="wetasphalt2" name="wetasphalt" value="Al lado carretera" required="" />
                             <label for="wetasphalt2">A lado de la carretera </label>
                            </div>
							</div>
							   <div class="form-group input-group-sm">
							 <div class="radio icheck-wetasphalt">
                            <input type="radio" checked id="wetasphalt3" name="wetasphalt" value="En ladera" required="" />
                             <label for="wetasphalt3">En ladera o en filos de cerro </label>
                            </div>
							</div>
          ...
          <div class="contenedor_cabesa_hogar" >
           ...
           <input name="numero_hogares" type="number"   tabindex="2" class="form-control" style="" autocomplete="on"  value="" style="width:200px"  required="">  
			     </div>
           <div class="form-group input-group-sm">  
					 <label for="title">Cuartos Usados </label>
           <input name="cuartos_usados" type="number"   tabindex="2" class="form-control" style="" autocomplete="on"  value="" style="width:200px" required="">  
			     </div>
			  </div>
          ...
          <input name="numero_cuertos" type="number"   tabindex="2" class="form-control" style="" autocomplete="on"  value="" style="width:200px" required=""> 
          </div>
          ...
          <div class="contenedor_cabesa_hogar" >
           ...
           <div class="col-md-6"> 
                <label for="title">Sistema de suministro de agua:</label>
                    <select name="suministro_agua_id" id="" class="form-control"   style="width:200px" required="" >
                    <option value="" selected disabled>Sistema de suministro de agua</option>
                   @foreach($suministro_agua as $key => $suministro_agua)
                  <option value="{{$key}}"> {{$suministro_agua}}</option>
                  @endforeach
                   </select>
                     <label for="title">¿Que tipo de servicio de energía?</label>
               <select name="servicio_energia_id" id="" class="form-control"   style="width:200px"  required="" >
               <option value="" selected disabled>Servicio de energía</option>
            ...
            <div class="col-md-6">
                 <label for="title">Servicio de internet? (fijo móvil)</label>
                <select name="servicio_internet" id="servicio_energia" class="form-control"   style="width:200px" required=""  >
                ...
                <select name="servicio_sanitario_id" id="servicio_internet" class="form-control"   style="width:200px" required="" >
                <option value="" selected disabled>Servicio sanitario</option>
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="contenedor_cabesa_hogar" >
              ...
              <div class="col-md-6"> 
                      ...
                      <select name="material_paredes_id" id="material_paredes" class="form-control" style="width:200px" required="" >
            	<option value="" selected disabled>Selecione Material paredes</option>
                  ...
                  @endforeach
                   ...
                   <select name="material_piso_id" id="material_piso" class="form-control"   style="width:200px" required=""  >
                   <option value="" selected disabled>Selecione Material piso</option>
                  ...
                  @endforeach
                   ...
                   <select name="estado_conservacion" id="material_piso" class="form-control"   style="width200px" required="" >
                    <option value="">Seleccione</option>
                   ...
                   <select name="forma_casa" id="" class="form-control"   style="width:200px" required=""  >
                    <option value="">Seleccione</option>
           ...
           <input name="" type="text"   tabindex="2" class="form-control" style="" autocomplete="on"  value="" style="width:200px" >  
            ...
            -->
                 ...
                 <label for="title">Material cocina :</label>
                    <select name="material_cocina_id" id="" class="form-control"  style="width:200px" required="" >
                    <option value="" selected disabled>Selecione Material Cocina </option>
                 ...
                 <label for="title">Material Techo:</label>
                   <select name="material_techo_id" id="" class="form-control"  style="width:200px" required="" >
                   <option value="" selected disabled>Selecione Material techo</option>
				 ...
				 <label for="title">Período de construcción: :</label>
                   <select name="periodo_construccion" id="material_piso" class="form-control"   style="width:200px" required="" >
                    <option value="">Seleccione</option>
					...
					<option value="50 en adelante">50 años en adelante</option>
                  </select>
				  
				   <label for="title">Área (tamaño) de la casa:</label>
                   <select name="tamaño_casa" id="material_piso" class="form-control"   style="width:200px" required=""  >
                    <option value="">Seleccione</option>
...
$('#Hogar').submit(function(e)
{
  ...
  if (result.dismiss === Swal.DismissReason.timer) {
    console.log('I was closed by the timer')
            ...
            setTimeout(function(){  location.href=base+"/Vivienda-Hogar/"+response.id; }, 2000);
          }
          else{
            Swal.fire({
              icon: 'error',
