				                    ...
				                    <td >
				                     <b  href=""  >NIVEL EDUCATIVO </b>
			                           ...
			                           <div  class="color_infor noPrint" style="margin-top: 15px;">  
					                     <span  class="color_infor  noPrint">Usted se encuentra en: &nbsp;&nbsp;Censo Poblacional Misak SIPEMP&gt; <font color="#666666">Educacion Formal</font></span>        
			                           </div>					
                      	...
                      	<!--<div id="SiEducacion" style="visibility: hidden; display: none;">	-->   
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
									  ...
									  <!-- <div class="form-group input-group-sm">
                                       ...
                                       <select name="municipioColegio" id="municipioColegio" class="form-control" style="width:" required="" >
                                       ...
                                       <input name="año_educacion1" id=" " type="date" tabindex="2" type="text"   style="width:160px"   tabindex="2" class="form-control" autocomplete="off" >
                                       </div>
           ...
           success:function(res){               
            if(res){
                ...
                $.each(res,function(key,value){
                    $("#colegio").append('<option value="'+key+'">'+value+'</option>');
                });
        ...
        $.ajax({
           ...
           success:function(res){               
            if(res){
                ...
                $.each(res,function(key,value){
                    $("#sede").append('<option value="'+key+'">'+value+'</option>');
                });
        ...
        $.ajax({
           ...
           success:function(res){               
            if(res){
                ...
                $.each(res,function(key,value){
                    $("#tipoE").append('<option value="'+key+'">'+value+'</option>');
                });
