...
<!-- INICIO DE  CODIGO DE FORMULARIO -->
				                    ...
				                    <td >
				                     <b  href=""  >NIVEL EDUCATIVO </b>
			                           ...
			                           <div  class="color_infor noPrint" style="margin-top: 15px;">  
					                     <span  class="color_infor  noPrint">Usted se encuentra en: &nbsp;&nbsp;Editar Hoja de Vida &gt; <font color="#666666">Información Básica</font></span>        
			                           </div>					
      ...
      Todos los campos son obligatorios
       ...
       <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">  
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12">
	               <div class="form-group input-group-sm">
                       <label ><span class="asterisco">*</span>Tipo de propiedad</label>
			              <div class="radio">
                          <label><input type="radio" name="optradio" checked>Propia</label>
                          </div>
          ...
          <div class="form-group input-group-sm">
           ...
           <!-- <label ><span class="asterisco">*</span>Código  de la vivienda</label>-->
             <input name="vivienda_id" type="text" 	value="{{$id_vivienda}}" tabindex="2"  class="form-control btn-warning" style="width:100px"   required="" >
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
          <div class="form-group input-group-sm">
           ...
           <div class="form-group input-group-sm">
		     ...
		     <select name="donde_preparan_alimento"  id="" tabindex="11" class="form-control" required="">
             <option value="">Selec el Lugar donde preparan el alimento</option>
           ...
           <div class="titulo_informacion">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group input-group-sm">
                    <label for=""><span class="asterisco">*</span>¿Como está fortaleciendo la Educación propia en su familia.?</label>
                      ...
                      <select name="forta_educacion_propia" id="" tabindex="49" class="form-control" required="">
              ...
              <div class="form-group input-group-sm">
                <label for=""><span class="asterisco">*</span>¿Cómo le gustaría que fuera la educación en el pueblo misak?. </label>
                       ...
                       <select name="gustar_edu_propia" id="DDLTraslado" tabindex="50" class="form-control" required="">
				 ...
				 <div  class="form-group input-group-sm">
                <label for=""><span class="asterisco">*</span>¿La Educación que brinda las instituciones educativas del resguardo de guambia es?</label>

                 
                   <select name="calidad_ie_guambia" id="" tabindex="50" class="form-control" required="">
              ...
              <div  class="form-group input-group-sm">
                <label for=""><span class="asterisco">*</span>¿Que debilidades ha visto hasta el momento, de la educación en el pueblo Misak?.</label>
                   ...
                   <select name="debilidades_ie_guambia" id="" tabindex="50" class="form-control" required="">
		            ...
		            <option value="4">D_ Docentes que no  contextualizan  desde el pensamiento holístico </option>
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
			 ...
			 <div class="form-group input-group-sm">
            <label for=""><span class="asterisco">*</span>¿Tiene estudiando hijos en las Instituciones Educativas del Resguardo de Guambía</label>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group input-group-sm">
                    ...
                    <select name="tiempo_comida_propia" id="" tabindex="49" class="form-control" required="" required="">
		             <option value="">Seleccione</option>
   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
           ...
           <div class="titulo_informacion">
             <h1>Informacion sobre  la sostenibilidad económica  y comidas propias que conoce la familia  </h1>
        ...
        <select name="departamento" id="departamento" class="form-control" style="width:" required="" >
         ...
         <div class="titulo_de_formulaario"></div>	
          ...
          <div class="ContentModulo_7">
		      ...
		      <button ><a href="#collapse5" class="btn btn-danger" data-parent="#accordion" data-toggle="collapse" class=""> Cerrar <i class="fa fa-plus"></i>  </a>  </button>
            
       
                <input type="submit" class="btn btn-success" value="Guardar" id="boton" class="btn btn-primary" >
         </div>
