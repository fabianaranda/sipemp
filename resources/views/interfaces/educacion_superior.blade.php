...
<!------------------>
   ...
   <!-- ///FORMULARIO////     -->
           ...
           <select name="tipo_educacion_superior" type="text"  maxlength="20" id="txtPrimerNombre" tabindex="3" class="form-control ">
...
<input type="submit" class="Agregareducacion" value="Agregar carrera de educacion superior" id="boton" class="btn btn-primary" >

           <button type="button" class="btn btn-danger" onclick="location.href='{{ url('familia_persona') }}'" >LIMPIAR</button>
