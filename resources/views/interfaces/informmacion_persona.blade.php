    ...
    <div class="col-md-9 ">
        <div class="ContenedorFormularioCenso">
            ...
            {{ csrf_field() }}
                ...
                <input name="hoga_id" style="visibility:hidden" type="text" class="form-control" style=""
                    autocomplete="of" value=" {{$datos->hogar_id }}">

                <input name="persona_id" style="visibility:hidden" type="text" value="{{$datos->id}}" tabindex="2"
                ...
                <div class="contenedor_informacion_persona">
                    ...
                    <div class="recuadro_info_persona"> INRESE INFORMACION GENERAL DE: {{$datos->nombres}}
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <select name="hijos_estudiando_guambia" id="ddGenero" tabindex="51" class="form-control"
                                    onchange="showGenero(this);" required="">
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <select name="empresa_asociativa" type="text" maxlength="20" id="txtPrimerNombre"
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <select name="carnet_salud_id" id="servicio_acueducto" class="form-control"
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <input name="telefono" type="text" class="form-control" style="" autocomplete="of"
                                    value="">
                            </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <select name="religion" type="text" maxlength="20" id="txtPrimerNombre" tabindex="3"
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <select name="enfemerma_recurre" type="text" maxlength="20" id="txtPrimerNombre"
                                    tabindex="3" class="form-control " required="">
                                    <option value="">Selec</option>
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <input name="comunidad_indigena" type="text" class="form-control" style=""
                                    autocomplete="of" value="11670001">
                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="btn-group" data-toggle="buttons">
                                                <label class="btn btn-conocimiento" class="btn btn-info active"
                                                    ...
                                                    <input name="habla_namuy_wam" value="No habla" data-val="true"
...
<!--                                         </fieldset>
                ...
                <div class="contenedor_informacion_persona">
                    ...
                    <div class="recuadro_info_persona">CONOCIMIENTOS ANCESTRALES DESDE SER MISAK DE: {{$datos->nombres}}
                        {{$datos->apellidos}} CC N° {{$datos->docomento_persona}}</div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <select name="medico_tradicional" type="text" maxlength="20" id="txtPrimerNombre"
                                    tabindex="3" class="form-control " required="">
                                    <option value="">Selec</option>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group input-group-sm">
                                <label f><span class="asterisco">*</span> usted tiene Conocimientos empíricos “Sabios ”
                                </label>
                                <select name="conocimientos_empiricos" type="text" maxlength="20" id="txtPrimerNombre"
                                    tabindex="3" class="form-control " required="">
                                    <option value="">Selec</option>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <select name="deporte_constante" type="text" maxlength="20" id="txtPrimerNombre"
                                    tabindex="3" class="form-control " required="">
                                    <option value="">Selec</option>
                            ...
                            <div class="form-group input-group-sm">
                                <label f><span class="asterisco">*</span>Conoce lugares sagrados dentro del resguardo de
                                    Guambia </label>
                                <select name="lugares_sagrados" type="text" maxlength="20" id="txtPrimerNombre"
                                    tabindex="3" class="form-control " required="">
                                    <option value="">Selec</option>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group input-group-sm">
                                <label f><span class="asterisco">*</span>¿Le Realizan baños en las diferentes etapas de
                                    la vida? </label>
                                <select name="baños_etapas_vida" type="text" maxlength="20" id="txtPrimerNombre"
                                    tabindex="3" class="form-control " required="">
                                    <option value="">Selec</option>
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <div id="Mujer" style="visibility: hidden; display: none;">
                                    <div class="form-group input-group-sm">
                                        ...
                                        <select name="no_estudia_guambia" id="ddMujer" tabindex="52"
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <select name="enfermedades_id" id="servicio_acueducto" class="form-control"
                                    style="width:" required="">
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <select name="medicina_alternativa" type="text" maxlength="20" id="txtPrimerNombre"
                                    tabindex="3" class="form-control " required="">
                                    <option value="">Selec</option>
                                    <option value="Ninguno">Ninguno </option>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <select name="consumo_sustancias" type="text" maxlength="20" id="txtPrimerNombre"
                                    tabindex="3" class="form-control " required="">
                                    <option value="">Selec</option>
                ...
                <div class="contenedor_informacion_persona">
                    ...
                    <div class="recuadro_info_persona"> FINALIZADO CON EL CENSO SOCIOCULTURAL DE: {{$datos->nombres}}
                        {{$datos->apellidos}} CC N° {{$datos->docomento_persona}}</div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
