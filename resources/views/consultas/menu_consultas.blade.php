...
<section class="cursos">    
  ...
  <div class="curso_hover"><p>Puedes realizar la consulta de las vivienda   de la comunidad Misak que vive dentro del resguardo  indígena de Guambia  </p>
  </div>
  <div> 
...
<b class="conten " onclick="location.href='{{ url('Informacion-hogar') }}'">
  <div class="curso_hover"><p>Puedes consultar el hogar  de las familia Misak que reside dentro del resguardo indígena de Guambia </p>
  </div>
  <div>
...
<b class="conten" onclick="location.href='{{ url('Informacion-Persona') }}'">
  <div class="curso_hover"><p>Puedes consultar  las personas que habitan dentro del resguardo de Guambia </p>
  </div>
  <div>
