...
<link rel="stylesheet" href="css/estilos_pie_pagina.css">
      ...
      <br>
       ...
       <br>
        ...
        <span  class="color_infor  ">Usted se encuentra en: &nbsp;&nbsp;<font color="#060505"> Sistema de Informacion Poblacional Misak -SIPEMP &gt; <font color="#060505">Consultas </font> &gt; <font color="#060505">Informacion Hogar</font> </span>        
         </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="profile_bg">
                ...
                <form id=""  class="form_cunsulta" name="form" action="/Informacion-hogar" method="POST" role="Informacion-hogar" class="pocicion_formulario">
				     	      {{ csrf_field() }}
			...
			<div class="ContenedorFormularioConsultasActualizacion">
              <div class="block-web full">
                <ul class="nav nav-tabs nav-justified nav_bg">  
                  <li class="active"><a href="#Informacion_del_sistema" data-toggle="tab"><i class="fa fa-laptop"></i>Información general  de Hogar </a></li>
				  <li class="active"><a href="#ingresar_usuarios" data-toggle="tab"><i class="fa fa-user"></i> Informacion de la vivienda del Hogar  </a></li>
