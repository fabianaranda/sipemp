      ...
      <div class="pull-left breadcrumb_admin clear_both">
       ...
       <br>
         <div  class="color_informacion_modulo " style="margin-top: 15px;">  
            <span  class="color_infor  ">Usted se encuentra en: &nbsp;&nbsp;<font color="#060505"> Sistema de Informacion Poblacional Misak -SIPEMP &gt; <font color="#060505">Consultas </font> &gt; <font color="#060505">Informacion Vivienda</font> </span>        
         </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="profile_bg">
                ...
                <form id=""  class="form_cunsulta" name="form" action="/Informacion-vivienda" method="POST" role="Informacion-hogar" class="pocicion_formulario">
				     	      {{ csrf_field() }}
							  
      						<div id="consulta_externa">
							
                  <input  id="nuip" name="q" class="inputbuscar" style="text-align:center"  title="El nùmero de cèdula debe ser de 2 a 10 dígitos" value="" style="width:100px"  autocomplete="of" > 
				...
				<div class="user-button">
                    ...
                    <input type="submit" id="boton" name="enviar" value="Buscar "  class="botonBuscar" style="width: 100px">
			...
			<div class="ContenedorFormularioConsultasActualizacion">
              <div class="block-web full">
                <ul class="nav nav-tabs nav-justified nav_bg">  
                  <li class="active"><a href="#Informacion_del_sistema" data-toggle="tab"><i class="fa fa-laptop"></i>Información General  de la Vivienda </a></li>
				  <li class="active"><a href="#ingresar_usuarios" data-toggle="tab"><i class="fa fa-user"></i> Informacion de la  Infrastructura   </a></li>
				 ...
				 <!---/////Informacion del sistema de informacion poblacional////////---->
                  ...
                  <!--  <h5><strong>INFORMACIÓN DE LA  PERSONA N°CC:  </strong> <b> </b></h5>
                      ...
                      <div class="row">
						...
						@if(isset($details))
            <h5><strong>	 Informacion de la Familia con el Codigo Hogar : {{ $query }} Son los siguientes. </strong></h5>
