      ...
      <div class="container">
                          ...
                          <td  title="Información de la persona que viven dentro de la familia " >
		                       <table   class="active">
			                       <tbody>
			                        <tr>
				                      <td >
				                          <b   onclick="location.href='{{ url('Menu-Usuarios') }}'"  >USUARIOS INGRESADOS EN  SIPEMP </b>
				                    </td>
			                        </tr>
		                         </tbody>
		...
		<!--
                       ...
                       <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6">
                                <input id="cargo" type="text" class="form-control @error('name') is-invalid @enderror" name="cargo" value="{{ old('cargo') }}" required autocomplete="cargo" autofocus>
