      ...
      <br>
       ...
       <br>
         <div  class="color_informacion_modulo " style="margin-top: 15px;">  
           <span  class="color_infor  ">Usted se encuentra en: &nbsp;&nbsp;<font color="#060505"> Sistema de Informacion Poblacional Misak -SIPEMP &gt; <font color="#060505">Actualizacion </font> &gt; <font color="#060505">Informacion General</font> </span>        
         </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="profile_bg">
                ...
                <form id=""  class="form_cunsulta" name="form" action="/Actualizacion-informacion-general" method="POST" role="informacion-perosona" class="pocicion_formulario">
				     	      {{ csrf_field() }}
			...
			<div class="ContenedorFormularioConsultasActualizacion">
              <div class="block-web full">
                <ul class="nav nav-tabs nav-justified nav_bg">  
                  <li class="active"><a href="#Informacion_del_sistema" data-toggle="tab"><i class="fa fa-laptop"></i>Actualizar Informacion General </a></li>
