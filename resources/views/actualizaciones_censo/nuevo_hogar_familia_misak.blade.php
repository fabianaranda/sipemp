 ...
 <link href="css/admin.css" rel="stylesheet" type="text/css" />
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
          ...
          <h2 class="">Hogar Misak</h2>
        </div>
        <div class="pull-right">
          <ol class="breadcrumb">
            <li><a href="#">Inicio</a></li>
            <li><a href="#">Ceonso Poblacional</a></li>
            <li class="active">Hogar Misak</li>
          </ol>
        </div>
      </div>
...
<!-- INICIO DE  CODIGO DE FORMULARIO -->
				                    ...
				                    <td >
				                     <b  href=""  >NIVEL EDUCATIVO </b>
			                           ...
			                           <div  class="color_infor noPrint" style="margin-top: 15px;">  
					                     <span  class="color_infor  noPrint">Usted se encuentra en: &nbsp;&nbsp;Censo poblacional Misak SIPEMP &gt; <font color="#666666">Censo Hogar</font></span>        
			                           </div>					
               ...
               Vivienda Misak
                 ...
                 <h3 class="h4">Si la familia que va realizar el censo población tiene vivienda Propia, ingresar en este módulo  censo vivienda  Misak. </h3>
                        ...
                        <p class="text-muted">
                         _______________________  </p>
                           <h4 class="panel-title">
                             ...
                             <button type="button" class="btn btn-primary" onclick="location.href='{{ url('Vivienda') }}'" >Ingresar</button>
   ...
   <div class="panel panel-default">
          <div class="well resume-module module-jobs" >
               ...
               Hogar Misak
   				...
   				<div class="js-box-laboral-experience" id="experiencia-laboral">
                 <h3 class="h4">Si la Familia vive   dentro de la vivienda de algún familiar, (Padre, tío) ingresar en este módulo Hogar Misak.  </h3>
                    <div class="module-collapsible collapse in" aria-expanded="true">
                       <div class="module-summary-wrapper laboral-experience">
                         <p class="text-muted">
                         ___________________</p>
                           <h4 class="panel-title">
		                     <button ><a href="#collapse5" type="button"  class="btn btn-primary"  data-parent="#accordion" data-toggle="collapse" class=""> Agregar 
                             <i class=""></i>  </a>
                             </button>
                            </h4>
						</div>
      ...
      <a class="cta-module-cancel js-cta-cancel" ">
        ...
        <div class="btn-help">
		    ...
		    <h4 class="panel-title">
		                     <button ><a href="#collapse5" data-parent="#accordion" data-toggle="collapse" class=""> Cerrar
       ...
       <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">  
                  ...
                  <div class="col-md-6 col-sm-12 col-xs-12">
	               <div class="form-group input-group-sm">
                       <label ><span class="asterisco">*</span>Tipo de propiedad</label>
			              <div class="radio">
                          <label><input type="radio" name="optradio"  value="Familiar" checked>Familiar</label>
                          </div>
                          <div class="radio">
                           <label><input type="radio" name="optradio"  value="Arrendada">Arrendada</label>
                         </div>
                         <!--<div class="radio">
          ...
          <div class="form-group input-group-sm">
            ...
            <div class="form-inline input-group-sm">
             ...
             <input name="vivienda_id" type="text" tabindex="2"  class="form-control" style="width:100px"  value="" required="">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
          <div class="form-group input-group-sm">
           ...
           <input name="total_personas_hogar" type="number"   tabindex="2" class="form-control" style="" autocomplete="on"  value="" style="width:200px" required="">  
         </div>
           ...
           <div class="form-group ">
            ...
            <div class="clearfix"></div>
            <div class="form-inline input-group-sm">
            <input name="numero_dormitorio" type="number"  value="ingresarr" tabindex="2" class="form-control" style="" autocomplete="on"  value="" style="width:200px" required="">  
		          
            <input name="dormitorio_usado" type="number"   tabindex="2" class="form-control" style="" autocomplete="on"  value="" style="width:200px" required="">  
           ...
           <div class="form-group input-group-sm">
             <label  style="width:300px" for="title">¿donde preparan los  alimentos?  :</label>
		     <select name="donde_preparan_alimento"  id=""  class="form-control"required="">
           ...
           <div class="titulo_informacion">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-6 col-sm-12 col-xs-12">
				     ...
				     <div class="form-group input-group-sm">
                      <label ><span class="asterisco">*</span>¿Número de Personas  que estan Estudiando actual mente?</label>
                      <input name="num_personas_estudiando" type="number"   tabindex="2" class="form-control" style="" autocomplete="on"  value="" style="width:200p" required="">  
                     
                     </div>
                  <div class="form-group input-group-sm">
                    <label for=""><span class="asterisco">*</span>¿Como está fortaleciendo la Educación propia en su familia.?</label>
                      
                      <select name="forta_educacion_propia" id="ddlSalario" tabindex="49" class="form-control" required="">
              ...
              <div class="form-group input-group-sm">
                <label for=""><span class="asterisco">*</span>¿Cómo le gustaría que fuera la educación en el pueblo misak?. </label>
                   
                       <select name="gustar_edu_propia" id="" tabindex="50" class="form-control"required="">
				 ...
				 <div  class="form-group input-group-sm">
                <label for="ddlSituacionLaboral"><span class="asterisco">*</span>¿La Educación que brinda las instituciones educativas del resguardo de guambia es?</label>

                 
                   <select name="calidad_ie_guambia"  tabindex="50" class="form-control"required="">
              ...
              <div  class="form-group input-group-sm">
                <label for=""><span class="asterisco">*</span>¿Que debilidades ha visto hasta el momento, de la educación en el pueblo Misak?.</label>

                 
                   <select name="debilidades_ie_guambia"  tabindex="50" class="form-control" required="">
		               
		            <option value="">Seleccione</option>
		            <option value="1">A:No hay modalidades que requieran los estudiantes</option>
		             <option  value="2">B: Falta de motivación por parte de los padres de familia.</option>
		             <option value="3">C: Falta de medios de transporte para dirigir a las instituciones donde se requiera.</option>
		            <option value="4">D: Docentes que no  contextualizan  desde el pensamiento holístico </option>
					 <option value="5">E:La educación en Guambia, si cumple las necesidades de la comunidad Misak  </option>
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
			 ...
			 <div class="form-group input-group-sm">
            <label for="ddNoEstudiaResguardo"><span class="asterisco">*</span>¿Tiene estudiando hijos en las Instituciones Educativas del Resguardo de Guambía</label>
            <select name="hijos_estudiando_guambia" id="ddNoEstudiaResguardo" tabindex="51" class="form-control" onchange="showNoEstudiaResguardo(this);"  required="">
		    <option value="">Seleccione</option>
            ...
            <div class="form-group input-group-sm">
                <label for="ddNoEstudiaResguardoEscuela"><span class="asterisco">*</span>¿Por qué no le gusta que sus hijos estudien en las instituciones educativas del resguardo de Guambia?</label>

                <select name="no_estudia_guambia" id="ddNoEstudiaResguardoEscuela" tabindex="52" class="form-control" style="display: none;"  >
		       <option value="">Seleccione</option>
		        <option value="1">A:Por qué solo enseñan lo propio</option>
		        <option value="2">B:Pierden mucho tiempo</option>
		        <option value="3">C:Los profesores no tienen buena metodología para enseñar</option>
		...
		<div id="DesercionEscuela" style="visibility: hidden; display: none;">
            <div class="form-group input-group-sm">
                ...
                <select name="deserción_guambia" id="ddNoEstudiaResguardoEscuela1" tabindex="52" class="form-control" style="display: none;" >
		        <option value="">Seleccione</option>
				 ...
				 <option value="4">E:Falta de motivación de los niños para permanecer en la institución educativa </option>
	      ...
	      <div class="titulo_informacion">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <div class="form-group input-group-sm">
                    <label for=""><span class="asterisco">*</span>¿Cada cuánto consume comidas propias?</label>
                      
                      <select name="tiempo_comida_propia" id="" tabindex="49" class="form-control" required="">
		             <option value="">Seleccione</option>
              ...
              <div class="form-group input-group-sm">
                <label for=""><span class="asterisco">*</span>¿Se alimenta con productos propios? </label>
                   
                       <select name="alimenta_producto_propio" id="" tabindex="50" class="form-control" required="">
		                <option value="">Seleccione</option>
				 ...
				 <div  class="form-group input-group-sm">
                <label for=""><span class="asterisco">*</span>¿Se alimenta con semillas nativas?</label>

                 
                   <select name="aliemnta_semillas_propio" id="" tabindex="50" class="form-control" required="">
              ...
              <div  class="form-group input-group-sm">
                <label for=""><span class="asterisco">*</span>¿Se alimenta con cultivos orgánicos? </label>

                 
                   <select name="aliemnta_cultivos_propios" id="" tabindex="50" class="form-control" required="">
         ...
         <div class="col-md-6 col-sm-12 col-xs-12">
            ...
            <select name="rituales_armonizacion" id="ddArmonizacion" tabindex="51" class="form-control" onchange="showArmonizacion(this);" required="">
		    <option value="">Seleccione</option>
            ...
            <div class="form-group input-group-sm">
                <label for="ddSiHaceArmonizacion"><span class="asterisco">*</span>Cada cuanto se hace a la armonizació</label>

                <select name="tiempo_rituales" id="ddSiHaceArmonizacion" tabindex="52" class="form-control" style="display: none;" >
		       <option value="">Seleccione</option>
   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
           ...
           <div class="titulo_informacion">
             <h1>Informacion sobre  la sostenibilidad económica  y comidas propias que consume la familia  </h1>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
           ...
           <div class="titulo_informacion">
             <h1>¿En el yatul Que tipo de Plantas Tiene ?. Seleccione las plantas que tiene en el yatul! </h1>
           ...
           <div class="col-md-6">
            ...
            <h4>* </h4>
				...
				<div class="pull-right ">
							...
							<button type="button" class="botones_censo_cancelar" onclick="location.href='{{ url('Hogar') }}'" >CANCELAR</button>
      ...
      $.ajax({
        ...
        success:function(response)
        {
          if(response.validate)
          {
            ...
            setTimeout(function(){  location.href=base+"/Nueva-Familia-Misak/"+response.id; }, 2000);
          
		  }
          else{
            //modal de error de guardado 
            Swal.fire({
              icon: 'error',
              title: 'Error',
