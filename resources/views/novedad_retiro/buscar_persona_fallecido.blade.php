      ...
      <div class="pull-right">
       ...
       <br>
         <div  class="color_informacion_modulo " style="margin-top: 15px;">  
           <span  class="color_infor  ">Usted se encuentra en: &nbsp;&nbsp;<font color="#060505"> Sistema de Informacion Poblacional Misak | SIPEMP &gt; <font color="#060505">Novedad Retiro  </font> &gt; <font color="#060505">Buscar Persona Fallecida</font> </span>        
         </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="profile_bg">
              ...
              <h4> Buscar  Doc. de la persona fallecida</h4>

              <form id=""  class="form_cunsulta" name="form" action="/Buscar-Persona-Fallecido" method="POST" role="informacion-perosona" class="pocicion_formulario">
                             {{ csrf_field() }}
          ...
          <div class="ContenedorFormularioCenso">
            <div class="block-web full">
              <ul class="nav nav-tabs nav-justified nav_bg">  
                <li class="active"><a href="#Informacion_del_sistema" data-toggle="tab"><i class="fa fa-laptop"></i>Informacion de la persona fallecida </a></li>
